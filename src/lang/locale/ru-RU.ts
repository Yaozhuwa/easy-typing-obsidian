...
const locale: Locale = {
    settings: {
        ...
        puncRectify: {
            name: "Автоматическое преобразование пунктуации",
            desc: "При вводе после символов CJK (китайский/японский/корейский) автоматически преобразует половинную пунктуацию в полноширинную: ,.?!:; → ，。？！：；"
        },
        printDebugInfo: {
