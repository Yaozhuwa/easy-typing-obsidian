...
const locale: Locale = {
    settings: {
        ...
        userDefinedRegexp: {
            ...
            desc: "用戶自定義正則表達式，匹配到的內容不進行格式化，每行一個表達式，行尾不要隨意加空格。" +
                ...
                "這兩個空格策略符號分別為匹配區塊的左右兩邊的空格策略。以 // 開頭的行作為註釋"
        },
    ...
    builtinRuleDescriptions: {
        ...
        'builtin-conv-backtick': '連續中文間隔號 ·· 轉行內代碼',
        'builtin-conv-codeblock': '行內代碼中繼續輸入 · 升級為代碼塊',
        ...
        'builtin-sel-wrap-backtick': '選中文字後輸入 · 包裹為行內代碼',
        'builtin-sel-wrap-symbols': '選中文字後輸入 【/¥/￥ 包裹為 []/$$',
